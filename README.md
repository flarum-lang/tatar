# Tatar language pack for [Flarum](https://flarum.org/)
...
This language pack contains Tatar translations for Flarum (compatible with `2.0.0` or newer) and popular extensions. Full list of supported extensions is available below.
